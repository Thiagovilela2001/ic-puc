...
- Modify `src/relatorio/config/agents.yaml` to define your agents
- Modify `src/relatorio/config/tasks.yaml` to define your tasks
- Modify `src/relatorio/crew.py` to add your own logic, tools and specific args
- Modify `src/relatorio/main.py` to add custom inputs for your agents and tasks
...
This command initializes the relatorio Crew, assembling the agents and assigning them tasks as defined in your configuration.
...
For support, questions, or feedback regarding the Relatorio Crew or crewAI.
